...
const JCXS0101_FIELDS: &[FieldDef] = &[
    ...
    FieldDef {
        ...
        length: 2,
        obligation: Obligation::M,
        code_ref: Some("JYT_1001_ID_TYPE"),
        source: Some("JCTB020104"),
        note: "取用 JCTB020104",
    },
    FieldDef {
        id: "JCXS010106",
    ...
    FieldDef {
        ...
        code_ref: Some("GBT_3304_ETHNICITY"),
        source: Some("JCTB020106"),
        note: "取用 JCTB020106",
    },
    FieldDef {
        id: "JCXS010108",
        ...
        length: 3,
        obligation: Obligation::O,
        code_ref: Some("GBT_2659_NATIONALITY"),
        source: Some("JCTB020107"),
        note: "取用 JCTB020107",
    },
    FieldDef {
        id: "JCXS010109",
        ...
        length: 1,
        obligation: Obligation::O,
        code_ref: Some("JYT_1001_HMT"),
        source: Some("JCTB020111"),
        note: "取用 JCTB020111",
    },
    FieldDef {
        id: "JCXS010110",
        ...
        length: 2,
        obligation: Obligation::O,
        code_ref: Some("GBT_4762_POLITICAL"),
        source: Some("JCTB020108"),
        note: "取用 JCTB020108",
    },
    FieldDef {
        id: "JCXS010111",
    ...
    FieldDef {
        ...
        length: 1,
        obligation: Obligation::O,
        code_ref: Some("JYT_1001_HEALTH"),
        source: Some("JCTB020109"),
        note: "取用 JCTB020109",
    },
    FieldDef {
        id: "JCXS010113",
...
const JCXS0201_FIELDS: &[FieldDef] = &[
    ...
    FieldDef {
        ...
        length: 1,
        obligation: Obligation::O,
        code_ref: Some("JYT_1001_ENROLL_TYPE"),
        source: None,
        note: "JY/T 1001",
    },
    FieldDef {
        ...
        length: 1,
        obligation: Obligation::O,
        code_ref: Some("JYT_1001_STUDY_MODE"),
        source: None,
        note: "JY/T 1001",
    },
    FieldDef {
        ...
        length: 1,
        obligation: Obligation::O,
        code_ref: Some("JYT_1001_STUDENT_CATEGORY"),
        source: None,
        note: "JY/T 1001",
    },
    FieldDef {
        ...
        length: 1,
        obligation: Obligation::M,
        code_ref: Some("JYT_1001_STATUS_STATE"),
        source: None,
        note: "JY/T 1001",
    },
    FieldDef {
...
const JCXS0204_FIELDS: &[FieldDef] = &[
    ...
    FieldDef {
        ...
        length: 1,
        obligation: Obligation::O,
        code_ref: Some("JYT_1001_AWARD_TYPE"),
        source: None,
        note: "JY/T 1001",
    },
    FieldDef {
        ...
        length: 1,
        obligation: Obligation::O,
        code_ref: Some("JYT_1001_AWARD_LEVEL"),
        source: None,
        note: "JY/T 1001",
    },
    FieldDef {
...
const JCXS0205_FIELDS: &[FieldDef] = &[
    ...
    FieldDef {
        ...
        length: 1,
        obligation: Obligation::O,
        code_ref: Some("JYT_1001_PUNISH_TYPE"),
        source: None,
        note: "JY/T 1001",
    },
    FieldDef {
        ...
        length: 1,
        obligation: Obligation::O,
        code_ref: Some("JYT_1001_PUNISH_LEVEL"),
        source: None,
        note: "JY/T 1001",
    },
    FieldDef {
