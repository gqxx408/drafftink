...
pub const ZXJZ010101: FieldDef = FieldDef {
    id: "ZXJZ010101",
    name: "教职工标识码",
...
pub const ZXJZ020101: FieldDef = FieldDef {
    id: "ZXJZ020101",
    name: "资质标识",
    data_type: DataType::C,
    length: 20,
...
pub const ZXJZ020102: FieldDef = FieldDef {
    id: "ZXJZ020102",
    name: "教职工标识码",
    data_type: DataType::C,
    length: 20,
...
pub const ZXJZ020103: FieldDef = FieldDef {
    id: "ZXJZ020103",
    name: "学校标识码",
    data_type: DataType::C,
    length: 20,
...
pub const ZXJZ020104: FieldDef = FieldDef {
    id: "ZXJZ020104",
    name: "资格类型",
    data_type: DataType::C,
    length: 20,
...
pub const ZXJZ020105: FieldDef = FieldDef {
    id: "ZXJZ020105",
    name: "证书编号",
    data_type: DataType::C,
    length: 30,
...
pub const ZXJZ020106: FieldDef = FieldDef {
    id: "ZXJZ020106",
    name: "发证日期",
...
pub const ZXJZ020107: FieldDef = FieldDef {
    id: "ZXJZ020107",
    name: "有效期至",
    data_type: DataType::D,
    length: 8,
...
pub const ZXJZ030101: FieldDef = FieldDef {
    id: "ZXJZ030101",
    name: "职务标识",
    data_type: DataType::C,
    length: 20,
...
pub const ZXJZ030102: FieldDef = FieldDef {
    id: "ZXJZ030102",
    name: "教职工标识码",
    data_type: DataType::C,
    length: 20,
...
pub const ZXJZ030103: FieldDef = FieldDef {
    id: "ZXJZ030103",
    name: "学校标识码",
    data_type: DataType::C,
    length: 20,
...
pub const ZXJZ030104: FieldDef = FieldDef {
    id: "ZXJZ030104",
    name: "岗位代码",
    data_type: DataType::C,
    length: 1,
    obligation: Obligation::M,
    code_ref: Some("JYT_1001_POST_CODE"),
    source: None,
    note: "",
};
pub const ZXJZ030105: FieldDef = FieldDef {
    id: "ZXJZ030105",
    name: "职务代码",
    data_type: DataType::C,
    length: 1,
    obligation: Obligation::M,
    code_ref: Some("JYT_1001_DUTY_CODE"),
    source: None,
    note: "",
};
pub const ZXJZ030106: FieldDef = FieldDef {
    id: "ZXJZ030106",
    name: "任职开始日期",
    data_type: DataType::D,
    length: 8,
...
pub const ZXJZ030107: FieldDef = FieldDef {
    id: "ZXJZ030107",
    name: "任职结束日期",
    data_type: DataType::D,
    length: 8,
